...
const Signup = () => {
  ...
  <div className='wrapper'>
        ...
        <Button variant="contained" color='success' onClick={addHandler}>Sign In</Button><br/><br/>
        <Button variant="text" color='success'  > <Link to={'/'} style={{textDecoration:"none", color:"black"}}>all ready have an account ? login</Link>
</Button>
